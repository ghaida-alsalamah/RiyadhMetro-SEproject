...
class TestJourneyHistoryWidget extends StatefulWidget {
  ...
  static String routeName = 'test_JourneyHistory';
  static String routePath = '/testJourneyHistory';
            ...
            children: [
              StreamBuilder<List<JourneysRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<JourneysRecord> conditionalBuilderJourneysRecordList =
                      snapshot.data!;
