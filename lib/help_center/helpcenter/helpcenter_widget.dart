                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                        ChatbotWquestionWidget.routeName);
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    '1oup2k3y' /* Talk to our chatbot */,
                                  ),
                                  options: FFButtonOptions(
                                    height: 38.6,
                                    padding: EdgeInsetsDirectional.fromSTEB(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                '6i6g9qw2' /* If you couldn't find what you'... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '6yssuc0r' /* Type your question or describe... */,
                                    ),
                            ...
                            FFButtonWidget(
                              ...
                              text: FFLocalizations.of(context).getText(
                                'kwp4uphv' /* View  previous queries */,
                              ),
                              options: FFButtonOptions(
                                height: 40.0,
                                padding: EdgeInsets.all(8.0),
