...
class QuaryCopy2Widget extends StatefulWidget {
  ...
  static String routeName = 'quaryCopy2';
  static String routePath = '/quaryCopy2';
                          ...
                          child: StreamBuilder<List<QuerysRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final listViewQuerysRecord =
                                  listViewQuerysRecordList.isNotEmpty
                                      ? listViewQuerysRecordList.first
                                      : null;
